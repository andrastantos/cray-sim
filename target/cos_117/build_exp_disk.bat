...
ds_edit.exe c -a  disk_content/bin/audit.bin    -o _obj/audit.ds
ds_edit.exe c -a  disk_content/bin/dmp10.bin    -o _obj/dmp10.ds
ds_edit.exe c -a  disk_content/bin/gencat.bin   -o _obj/gencat.ds
ds_edit.exe c -a  disk_content/bin/jcsdef.bin   -o _obj/jcsdef.ds
ds_edit.exe c -a  disk_content/bin/loadcat.bin  -o _obj/loadcat.ds
ds_edit.exe c -a  disk_content/bin/pld10.bin    -o _obj/pld10.ds
ds_edit.exe c -a  disk_content/bin/prvdef.bin   -o _obj/prvdef.ds
ds_edit.exe c -a  disk_content/bin/tedi.bin     -o _obj/tedi.ds
ds_edit.exe c -a  disk_content/bin/acctdef.bin  -o _obj/acctdef.ds
ds_edit.exe c -a  disk_content/bin/recio.bin    -o _obj/recio.ds
ds_edit.exe c -a  disk_content/bin/reload.bin   -o _obj/reload.ds
copy disk_content\bin\recall.ds _obj\recall.ds
